import numpy as np
from src.nexi.models.functions.nexi_functions import M, nexi_signal, nexi_jacobian, nexi_hessian, \
    nexi_signal_from_vector, nexi_optimized_mse_jacobian
...
def test_nexi_jacobian():
    ...
    expected_result = np.array([[1.54514401e-04, -4.62179508e-02, -2.28483192e-01, 2.25580692e-01],
...
def test_nexi_hessian():
    ...
    expected_result = np.array([[[-8.67335582e-06, -1.55651863e-06,  2.18045281e-04, 1.36086092e-04],

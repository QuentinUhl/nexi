...
def estimate_nexi_noiseless(dwi_path, bvals_path, td_path, out_path, mask_path=None, debug=False):
    """
...
if __name__ == '__main__':
    ...
    estimate_nexi_noiseless(args.dwi_path, args.bvals_path, args.td_path, args.out_path, args.mask_path, args.debug)
